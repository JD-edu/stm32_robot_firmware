...
int16_t pitch, roll, yaw; // Filtered orientation angles (scaled)

volatile int32_t encoder_count = 0;  // variable holds encoder value
...
void Compute_Orientation_Kalman(); // Computes pitch, roll, and yaw using a Kalman filter
/* USER CODE END PFP */
