# STM32 I2C1을 열어서 MPU6050의 ID를 읽는 방법
...
# USART2를 사용하려해요 일단은 STM32 -> PC로 데이터를 보내기
...
```
STM32 cubeMx로 I2C를 읽고 있는데 다음에서 에러가 발생
...
# MPU6050을 STM32에서 I2C1으로 access 할때, WHO_AM_I는 읽는데 성공. 가속도센서 셋팅 
...
# MPU6050 레지스터중 가속도센서 데이터 레지스터의 주소
...
# printf() 함수: USART가 printf와 연결하는 방법
